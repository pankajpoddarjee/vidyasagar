...
@media only screen and (min-width: 1050px) {.footer{position:fixed; bottom:0; padding:0}}
    ...
    <section style="margin:30px 0 0 0">
        <div class="container">
        	<div class="row">
            	<div class="col-md-12">
                	<h3 class="border-bottom"><i class="fa fa-user"></i> Candidate Login</h3>
                </div>
            </div>
                    ...
                    <div class="col-md-5 text-center mb-3">
                        <div class="row justify-content-center mt-3">
                        	<div class="col-md-12 text-center mb-3">
                                <a href="retreiveForPayStatus.php" type="button" class="btn btn-dark btn-block">Already Paid ? Click here to Retrieve</a>
                            </div>
                            <div class="col-md-12 text-center mb-3">
                                <a href="Notice/BA(H)_General_Subject_for_SEM_II_2020_21.pdf" class="btn btn-info btn-block" target="_blank">
                                    General Subjects BA Hons Sem II
                                </a>
                            </div>
                            <div class="col-md-12 text-center">
                                <a href="Notice/BSC(H)_General_Subject_for_SEM_II_2020_21.pdf" class="btn btn-info btn-block" target="_blank">
