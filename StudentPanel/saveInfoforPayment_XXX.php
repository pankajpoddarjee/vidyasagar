...
$presentsemester = $_POST["hdnsemester"];
...
// $qry	= "UPDATE studentmaster SET admissionToSemester='".$admittedsemester."',applcntMobNo='".$mobileno."', applcntEmail='".$email."' where session='".ACADEMIC_SESSION."' and semester='".$presentsemester."' and RollNo='".$rollno."' ;";
 ...
 $qry	= "UPDATE studentPaymentDetail SET admissionToSemester='".$admittedsemester."',applcntMobNo='".$mobileno."', applcntEmail='".$email."' where session='".ACADEMIC_SESSION."' and semester='".$presentsemester."' and RollNo='".$rollno."' and FeeCode='ADMFEE' ;"; 
