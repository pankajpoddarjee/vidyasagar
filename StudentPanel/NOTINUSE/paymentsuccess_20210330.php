...
$isValid=1;
	if($splitdata[14]=="0300") {
		$sqlUpdate="update studentmaster set statuscode='".$statusCode."', onlineTransactionID = '".$transactionno."' , statusdescription='".$statusdescription."',onlineTransactionDate = '".$transactionDate."' ,onlineTransactionAmount = '".$transAmount."',paymentdate='".date('d/m/Y')."', Paid='Y' where RollNo='".$rollno."' and admissionToSemester='".$semesterval."';";
	}
	else {
		$sqlUpdate="update studentmaster set statuscode='".$statusCode."', onlineTransactionID = '".$transactionno."' , statusdescription='".$statusdescription."',onlineTransactionDate = '".$transactionDate."' ,onlineTransactionAmount = '".$transAmount."'  where RollNo='".$rollno."' and admissionToSemester='".$semesterval."';";
	
	}
	 
$qryresult = mssql_query($sqlUpdate);
...
$qry	=	"select * from studentmaster where  RollNo='".$rollno."' and admissionToSemester='".$semesterval."';";
...
$paidstaus  =$studrecord[0]["Paid"];
$transactionamount = $studrecord[0]["onlineTransactionAmount"];
$dept = $studrecord[0]["department"];
$FeeCode = $studrecord[0]["FeeCode"];
$semester = $studrecord[0]["admissionToSemester"];
 


//$feeqry =" select * from FeeStructure where department='".$dept."' and semester='".$semester."';";
$feeqry =" select * from FeeStructure where FeeCode='".$FeeCode."' and Semester='".$semester."';";
                	...
                	<div class="row" style="margin-bottom:12px">
                    	<div class="col-lg-12">
                        	<p style="text-align:center; margin:0">
                            	<img src="<?php echo COLLEGE_LOGO;?>" alt="Logo" width="55">
                            </p>
                        </div>
                        <div class="col-lg-12 col-sm-12">
                        	<p style="text-align:center; margin:0 0 0 0; font-family:oldenglish; font-size:30px; color:#000">
                            ...
                            <table width="100%" border="0" bordercolor="#666666" cellspacing="0" cellpadding="5" style="border-collapse:collapse; font-size:12px; text-align: left; line-height: 18px; font-family:Poppins" class="tabl">
                                <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td class="TD2"><?php echo $studrecord[0]["CourseType"];?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <?php if($statuscode==0300 && $paidstaus=='Y') {?>
                                    <tr>
                            ...
                            <table width="100%" border="0" bordercolor="#666666" cellspacing="0" cellpadding="5" style="border-collapse:collapse; font-size:12px; text-align: left; line-height: 18px; margin-bottom:10px" class="tabl">
                            	<tbody>
                                    <tr>
                                      ...
                                      <td class="TD2"><i class="fa fa-inr"></i> <strong style="color:#c00"><?php echo moneyFormatIndia($feerecord[0]["FeeAmount"]);?></strong> <span class="brake1"><br></span>(<?php echo amountinword($feerecord[0]["FeeAmount"]);?>)</td>
                                    </tr>
                                </tbody>
                            </table>
