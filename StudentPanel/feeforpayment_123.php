...
if($fetchresult) {
  ...
  $qry	=	"select spd.*,  ccm.subjectName as department  from studentPaymentDetail spd JOIN studentmaster st ON st.collegeRollno=spd.collegeRollNo  JOIN College_CourseMaster ccm ON ccm.subjectcode=st.appsubjectcode where ltrim(rtrim(session))='".ACADEMIC_SESSION."'   and semester='".$semester."' and spd.RollNo='".$rollno."' and studentStatus=1;";
							...
							<div class="PaymentDetail_container">
								<div class="row">
									<div class="col-lg-12">
										<table width="100%" border="0" bordercolor="#666666" cellspacing="0" cellpadding="5" style="border-collapse:collapse; font-size:12px; text-align: left; line-height: 18px; font-family:Poppins" class="tabl">
											<tbody>
												...
												<tr>
												  ...
												  <td class="TD2"><span style="color:#c00"><?php echo $studrecord[0]["admissionToSemester"];?></span></td>
												</tr>   
												<tr>
										...
										<form name="frmbilldesk" id="frmbilldesk" action="Epayment.php"  method="post"> 
