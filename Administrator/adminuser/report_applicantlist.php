...
<body onload="fillstream();">
    ...
    <div id="content">
        ...
        <form id="frmeligiblereport" name="frmeligiblereport" action="" method="post">
        <div class="container">
        	<div class="row">
            	<div class="col-md-12">
                    <h5 class="text-danger border-bottom mb-3 pb-2">
                    	<i class="fa fa-bar-chart"></i> List of Student
                    </h5>
                </div>
				...
				<div class="col-md-4">
                	<div class="input-group mb-3">
                        ...
                        <select id="chosemester" name="chosemester" class="custom-select" >
                                <option value="All" selected>All</option>
				...
				<div class="col-md-4">
                	<div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text">Domicile</span>
                        </div>
                        <select id="choDomicile" name="choDomicile" class="custom-select" >
                                <option value="All" selected>All</option>
				...
				<div class="col-md-4">
                	<div class="input-group mb-3">
                        ...
                        <select id="chocategory" name="chocategory" class="custom-select" >
                                <option value="All" selected>All</option>
								 <option value="GENERAL">GENERAL</option>
								  <option value="OBC-A">OBC-A</option>
								  <option value="OBC-A">OBC-B</option>
				 ...
				 <div class="col-md-4">
                	<div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text">Minority</span>
                        </div>
                        <select id="chominority" name="chominority" class="custom-select" >
                                <option value="All" selected>All</option>
				 ...
				 <div class="col-md-4">
                	<div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text">BPL</span>
                        </div>
                        <select id="choAPLBPL" name="choAPLBPL" class="custom-select" >
                                <option value="All" selected>All</option>
								 <option value="YES">Yes</option>
								  <option value="NO">No</option>
                         </select>
            ...
            <div class="row justify-content-center">
                <div class="col-md-4 text-center">
                    <a type="button" id="btnsubmit" name="btnsubmit" onclick="getApplicant()" class="btn btn-primary text-white btn-sm"><i class="fa fa-check-circle mr-2"></i>Submit</a>
...
<script src="adminuser_js/report.js"></script>
 ...
 function export2excel(sipl) {
  ...
  sipl.setAttribute("download", "ApplicantList.xls"); // Choose the file name
  return false;
}
</script>