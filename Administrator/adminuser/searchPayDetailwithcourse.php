...
cd.semester,cd.CoreCourse1,cd.CoreCourse2,cd.CoreCourse3,cd.generalCourse,cd.LCC,cd.DSE1,cd.DSE2, cd.DSE3,cd.AECC,cd.SEC from studentmaster st LEFT JOIN studentSemesterCourse cd ON cd.collegeRollno=st.collegeRollno WHERE ISNULL(studentActiveStatus,0)=1 ".$coursestr."  and cd.semester='".$_POST["choadmitsem"]."' ;";
