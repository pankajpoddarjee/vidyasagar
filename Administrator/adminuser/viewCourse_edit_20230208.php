        ...
        <div class="container">
        	<div class="row">
                ...
                ?>
					...
					if($headlabel=='Semester') {
					?>
					 <td>
					 <?php if($coursedetail[$headkey]=='I' || $coursedetail[$headkey]=='II') {  echo $coursedetail[$headkey];  } else {?>
					 <a href="javascript: void(0)" onclick="goforCourseeditBySem('<?php echo $coursedetail[$headkey];?>')"><?php echo $coursedetail[$headkey];?></a>
					 <?php } ?>
					 </td>
					 
					<?php } if($headlabel!='Semester') { ?>
