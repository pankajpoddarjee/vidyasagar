...
<title><?php echo COLLEGE_CODE; ?> | <?php echo PROGRAMME_CODE; ?> |  Other Fee Payment Report</title>
        ...
        <div class="container">
        	<div class="row">
            	<div class="col-md-12">
                    <h5 class="text-danger border-bottom mb-3 pb-2">
                    	<i class="fa fa-bar-chart"></i> List of Other Fee Payment Detail  
                    </h5>
                </div>
				<div class="col-md-4">
            ...
            <div class="row justify-content-center">
                <div class="col-md-4 text-center">
                    <a type="button" id="btnsubmit" name="btnsubmit" onclick="searchOtherPaymentDetail()" class="btn btn-primary text-white btn-sm"><i class="fa fa-check-circle mr-2"></i>Submit</a>
