...
if($collegeRollno !='') {
	if($semester=='I') {
	    ...
	    $qry	=	"select * from studentmaster st JOIN studentPaymentDetail sp ON st.collegeRollno=sp.collegeRollNo WHERE st.collegeRollno='".$collegeRollno."' and semester='".$semester."' and session='".$session."' and isnull(sp.Paid,'')='Y';";
	}
}
