...
<title><?php echo COLLEGE_CODE; ?> | <?php echo PROGRAMME_CODE; ?> |  Admission Fee Payment Report</title>
        ...
        <div class="container">
        	<div class="row">
            	<div class="col-md-12">
                    <h5 class="text-danger border-bottom mb-3 pb-2">
                    	<i class="fa fa-bar-chart"></i> List of Admission Fee Payment Detail
                    </h5>
                </div>
				<div class="col-md-4">
                	<div class="input-group mb-3">
                        ...
                        <select id="chosession" name="chosession" class="custom-select" onchange="fillAdmfeetype(this.value)">
				...
				<div class="col-md-4">
                	<div class="input-group mb-3">
                        ...
                        <select id="chofeeType" name="chofeeType" class="custom-select" onchange="fillAdmSemester(this.value)" >
                                <option value="All" selected>All</option>
				...
				<div class="col-md-4">
                	<div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text">To be Admitted Semester</span>
                        </div>
                        <select id="choadmitsem" name="choadmitsem" class="custom-select" >
                                <option value="All" selected>All</option>
            ...
            <div class="row justify-content-center">
                <div class="col-md-4 text-center">
                    <a type="button" id="btnsubmit" name="btnsubmit" onclick="searchPaymentDetail()" class="btn btn-primary text-white btn-sm"><i class="fa fa-check-circle mr-2"></i>Submit</a>
...
$('#txtPaymentDateFrom,#txtPaymentDateTo').datepick({dateFormat: 'dd-mm-yyyy',minDate:paymindate,maxDate:paymaxdate});
 ...
 function export2excel(sipl) {
  ...
  sipl.setAttribute("download", "AdmissionPayment.xls"); // Choose the file name
  return false;
}
</script>