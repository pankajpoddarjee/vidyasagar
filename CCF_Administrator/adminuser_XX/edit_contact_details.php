            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="input-group mb-3">
						...
						<input type="text" id="txtMobileNo" name="txtMobileNo" class="form-control" placeholder="Enter Applicant mobile no." maxlength="10" onKeyPress="inputNumber(event,this.value,false);">
                ...
                <div class="col-md-4">
                    <div class="input-group mb-3">
						...
						<input type="text" id="txtotherMobileNo" name="txtotherMobileNo" class="form-control" placeholder="" maxlength="10" onKeyPress="inputNumber(event,this.value,false);">
				...
				<div class="col-md-4">
						<div class="input-group mb-3">
							<div class="input-group-prepend">
								<span class="input-group-text">Have WhatsApp No.? <span class="text-danger">*</span></span>
							</div>
						<select id="hasWhatsAppno" name="hasWhatsAppno" class="custom-select" onchange="displayforOther(this.value,'Yes','span_WhatsAppno','txtWhatsAppNo')">
								<option value="">Select</option>
				...
				<div class="col-md-4" id="span_WhatsAppno" style="display:none">
					<div class="input-group mb-3">
						<div class="input-group-prepend">
							<span class="input-group-text">WhatsApp No. <span class="text-danger">*</span></span>
						</div>
						<input type="text" id="txtWhatsAppNo" name="txtWhatsAppNo" class="form-control" placeholder="Enter Whatsapp No." maxlength="10" onKeyPress="inputNumber(event,this.value,false);">
						<small class="mt-1">This number must remain valid during the entire tenure of the course, as this number will be used for any communication.</small>
					</div>
				</div>
                ...
                <div class="col-md-4">
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                         ...
                         <input type="text" id="txtemailId" name="txtemailId" maxlength="100" class="form-control" placeholder="Enter Valid E-mail Id">
