                    ...
                    <div class="row mt-3" id="GeneralGEInfo" style="display:none;">
                        <div class="col-md-6">
                            <div class="input-group mb-3">
                                ...
                                <select class="custom-select" id="cboGeneral1subject" name="cboGeneral1subject">
                                	<option value="">Select</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="input-group mb-3">
                                ...
                                <select class="custom-select" id="cboGeneral2subject" name="cboGeneral2subject">
                                	<option value="">Select</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6" id="GeneralGE3Info" style="display:none">
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">Minor 3 <span class="text-danger">*</span></span>
                                </div> 
                                <select class="custom-select" id="cboGeneral3subject" name="cboGeneral3subject" >
                                	<option value="">Select</option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row" id="GeneralElectiveInfo" style="display:none;">
                        <div class="col-md-6">
                            <div class="input-group mb-3">
                                ...
                                <select class="custom-select" id="cboGEGeneralsubject" name="cboGEGeneralsubject">
                                	<option value="">Select</option>
                                </select>
                            </div>
                        </div>
