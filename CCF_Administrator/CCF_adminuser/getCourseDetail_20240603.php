...
courseName,UPPER(MIL) as MIL, GE1 , GE2 , CORE1 , CORE2 , CORE3_GE3 ,GE1Code,GE2Code, CORE1Code,CORE2Code, CORE3_GE3Code,AECC1,	AECC1_Code,LCC2,LCC2_Code  from studentmaster st JOIN CU_course course ON course.stream=st.appstream WHERE st.collegeRollNo='".$collegerollno."';";
