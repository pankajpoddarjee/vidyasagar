    ...
    <div id="content">
        ...
        <div class="container-fluid mt-4">        
        	<div class="row p-0 m-0">
                <div class="col-md-4 border-bottom mb-3 text-left p-0">
                	<h5 class="sub_head">
                ...
                <div class="col-md-4 border-bottom hide_border_bottom_mobile mb-3 text-right p-0">
                	<button class="btn btn-outline-danger btn-sm" data-toggle="modal" data-target="#add-subject-modal"><i class="fa-solid fa-users"></i> Associate Subject</button>
                </div>
                <div class="col-md-4 border-bottom hide_border_bottom_mobile mb-3 text-right p-0">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form method="post" id="associate-subject-form">
                    <div class="modal-header">
                        <h4 class="modal-title" style="font-family:Oswald">Add Subject</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                ...
                success:function(data)
                {
                    ...
                    if(data.status==1){
                        ...
                        for (let i = 0; i < data.subjectRecord.length; i++) {
                            html += '<option value="' + data.subjectRecord[i].subject_id + '">' + data.subjectRecord[i].SubjectName_SDMS + '</option>';
                        }
