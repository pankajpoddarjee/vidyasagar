...
if(!empty($_POST['action']) && $_POST['action'] == 'listRecordsUpload') {
    ...
    foreach ($contentRecord as $record) {
        ...
        $rows[] = '<button class="btn btn-info open-edit-material-modal" cid="'.$record['content_id'].'" data-toggle="tooltip" data-placement="top" title="Edit Material">
        <i class="fa-solid fa-pen-to-square"></i>
        </button>
        <button class="open-delete-material-modal btn btn-'.$status_class.'" status="'.$record['is_active'].'" cid="'.$record['content_id'].'" data-toggle="tooltip" data-placement="top" title="Change Status"><i class="fa-solid fa fa-trash"></i></button>';
