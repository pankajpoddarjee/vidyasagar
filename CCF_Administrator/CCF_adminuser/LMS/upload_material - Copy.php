                ...
                <div class="col-md-12 text-center">                    
                    ...
                    <table class="table table-bordered " >
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo $value['video_link']; ?>" target="_blank">Click Here</a></td>   
                            <?php } else { ?>
                            <td><a href="<?php echo $value['document_path']; ?>" target="_blank">Click Here</a></td>   
                            <?php } ?>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form method="post" id="delete-study-material-form">
                    <div class="modal-header">
                        <h5 class="modal-title text-danger" id="material-title">Update Material Status</h5>
