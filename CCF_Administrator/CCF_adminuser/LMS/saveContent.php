...
else
{
        ...
        $qryInsert = $dbConn->prepare('INSERT INTO LMS_study_material (course_id,stream_id,department_id,material_id,paper_type_id,semester_id,teacher_id,subject_id,created_by,created_at,created_device)VALUES (:course_id,:stream_id,:department_id,:material_id,:paper_type_id,:semester_id,:teacher_id,:subject_id,:created_by,:created_at,:created_device)');
