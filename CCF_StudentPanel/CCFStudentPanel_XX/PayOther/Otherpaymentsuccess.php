...
$isValid=1;
	if($splitdata[14]=="0300") {
		$sqlUpdate="update studentPaymentDetail set statuscode='".$statusCode."', onlineTransactionID = '".$transactionno."' , statusdescription='".$statusdescription."',onlineTransactionDate = '".$transactionDate."' ,onlineTransactionAmount = '".$transAmount."',paymentdate='".date('d-m-Y')."',paymentId='".$paymentId."',Paid='Y' where id=".$paydetailid.";";
		
			$sqlUpdate .="UPDATE  transaction_history SET FeeCode='".$FeeCode."',onlineTransactionID='".$transactionno."', onlineTransactionDate='".$transactionDate."', paymentdate='".date('d-m-Y')."', statuscode='".$statusCode."',statusdescription='".$statusdescription."',onlineTransactionAmount='".$transAmount."',Paidstatus='Y' WHERE payDetailId=".$paydetailid." and rollno='".$rollno."' and paymentId='".$paymentId."';";
	}
	else {
		$sqlUpdate="update studentPaymentDetail set statuscode='".$statusCode."', onlineTransactionID = '".$transactionno."' , statusdescription='".$statusdescription."',onlineTransactionDate = '".$transactionDate."' ,onlineTransactionAmount = '".$transAmount."',paymentId='".$paymentId."'  where id=".$paydetailid.";";
		
	$sqlUpdate .="UPDATE  transaction_history SET FeeCode='".$FeeCode."',onlineTransactionID='".$transactionno."', onlineTransactionDate='".$transactionDate."', paymentdate='".date('d-m-Y')."', statuscode='".$statusCode."',statusdescription='".$statusdescription."',onlineTransactionAmount='".$transAmount."'  WHERE payDetailId=".$paydetailid." and rollno='".$rollno."' and paymentId='".$paymentId."';";
	
	}
	
	  //die($sqlUpdate);
	 
$qryresult = $dbConn2->query($sqlUpdate);
