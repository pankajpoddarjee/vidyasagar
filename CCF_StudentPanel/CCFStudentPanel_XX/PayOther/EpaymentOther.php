...
$refId = randomRefno(5);
 ...
 // $str =BILLERID.'|'.$rollno.'|'.$studrecord[0]["id"].'|'.$feerecord[0]["FeeAmount"].'|NA|NA|NA|INR|NA|R|'.SECURITYID.'|NA|NA|F|'.$studrecord[0]["name"].'|'.$studrecord[0]["department"].'|'.$studrecord[0]["FeeCode"].'|NA|'.$studrecord[0]["session"].'|'.$semester.'|'.$studrecord[0]["id"].'|'.BASE_URL_STUDENT.'/PayOther/Otherpaymentsuccess.php';
  ...
  $str =BILLERID.'|'.$refId.'|'.$studrecord[0]["id"].'|'.$feerecord[0]["FeeAmount"].'|NA|NA|NA|INR|NA|R|'.SECURITYID.'|NA|NA|F|'.$rollno.'|'.$studrecord[0]["department"].'|'.$studrecord[0]["FeeCode"].'|NA|'.$studrecord[0]["session"].'|'.$semester.'|'.$studrecord[0]["id"].'|'.BASE_URL_CCF_STUDENT.'/PayOther/Otherpaymentsuccess.php';
