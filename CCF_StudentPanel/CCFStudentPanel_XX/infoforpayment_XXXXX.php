...
if($fetchresult) {
   ...
   $qry	=	"select st.name,st.collegeRollNo,st.applcntMobNo,st.applcntEmail,spd.RollNo,spd.semester,ccm.streamDisplay,ccm.streamType,ccm.subjectName,ccm.subjectcode,isnull(spd.Paid,'') as Paid,spd.statuscode from studentPaymentDetail spd JOIN studentmaster st ON st.collegeRollno=spd.collegeRollNo JOIN College_CourseMaster ccm ON ccm.subjectcode=st.appsubjectcode where  ltrim(rtrim(session))='".ACADEMIC_SESSION."'   and semester='".$semester."' and spd.collegeRollNo='".$rollno."' ;";
                ...
                <div class="PaymentDetail_container">
                	<div class="row">
            			<div class="col-lg-12">
                            ...
                            <form name="frmnext1" id="frmnext1" action="feeforpayment.php"  method="post">
                            ...
                            <table width="100%" border="0" bordercolor="#666666" cellspacing="0" cellpadding="5" style="border-collapse:collapse; font-size:12px; text-align: left; line-height: 18px; font-family:Poppins" class="tabl">
                                <tbody>
									...
									<tr>
                                      ...
                                      <td class="TD2">
									  <select id="choAdmitedSemester" name="choAdmitedSemester" class="form-control" onchange="getOtherSubforsemester(this.value)">
