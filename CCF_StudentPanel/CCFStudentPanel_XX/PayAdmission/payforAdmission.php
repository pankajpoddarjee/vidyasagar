...
$totalfee = 0;
   ...
   $feeqry =" select * from College_FeeStructureMaster where  sesssionYear='".$studrecord[0]["session"]."' and feeCode='".$studrecord[0]["FeeCode"]."' and Semester='".$studrecord[0]["admissionToSemester"]."';";
