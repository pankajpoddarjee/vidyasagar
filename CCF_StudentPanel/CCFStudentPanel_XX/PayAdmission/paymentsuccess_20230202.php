...
$isValid=1;
	if($splitdata[14]=="0300") {
		...
		$sqlUpdate .="INSERT INTO transaction_history (payDetailId,FeeCode,rollno,onlineTransactionID, onlineTransactionDate, paymentdate, statuscode,statusdescription,onlineTransactionAmount,Paidstatus) VALUES(".$paydetailid.",'".$FeeCode."','".$rollno."','".$transactionno."','".$transactionDate."', '".date('d-m-Y')."','".$statusCode."','".$statusdescription."','".$transAmount."','Y');";
	}
	else {
