                ...
                <div class="PaymentDetail_container">
                	<div class="row">
            			<div class="col-lg-12">
                            ...
                            <input type="hidden" id="hdnInternshipVal" name="hdnInternshipVal"  /> 
                            <table width="100%" border="0" bordercolor="#666666" cellspacing="0" cellpadding="5" style="border-collapse:collapse; font-size:12px; text-align: left; line-height: 18px; font-family:Poppins; margin-top:5px" class="tabl">
                                <tbody>
									...
									<tr id="Internship"  style="display: none">
                                      <td class="TD1">Internship <span style="color:#F00">*</span></td>
                                      <td class="TD2"> <select id="choInternship" name="choInternship" class="form-control"  >
										<!--<option value="">Select</option>
