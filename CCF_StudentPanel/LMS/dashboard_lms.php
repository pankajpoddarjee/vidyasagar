            ...
            <div class="container">
                <div class="row" style="font-family:Montserrat">
                	<div class="col-md-4 animatehov">
                    	<section class="mx-auto my-5 shadow steps_follow_animation" style="max-width: 23rem;">
                            <div class="card testimonial-card mb-3">
                                <div class="card-up aqua-gradient"></div>
                                <div class="avatar mx-auto white">
                                    <img src="../../images/LMS_icon.jpg" class="img-fluid rounded-circle" alt="">
                                </div>
                                <div class="card-body text-center">
                                    <h5 class="card-title text-uppercase">Learning Materials</h5>
                                    <hr>
                                    <a class="btn btn-danger steps_follow_animation2" href="view_study_material.php">
                                        Learn more
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="col-md-4 animatehov">
                    	<section class="mx-auto my-5 shadow steps_follow_animation" style="max-width: 23rem;">
                            <div class="card testimonial-card mb-3">
                                <div class="card-up aqua-gradient"></div>
                                <div class="avatar mx-auto white">
                                    <img src="../../images/Student_Grievance_icon.jpg" class="img-fluid rounded-circle" alt="">
                                </div>
                                <div class="card-body text-center">
