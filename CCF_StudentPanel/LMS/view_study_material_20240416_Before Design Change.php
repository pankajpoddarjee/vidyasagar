...
left join CU_Master_Subject_Code_Type  as msc on msc.subject_id = sm.subject_id where sc.is_active=1 and CONCAT(',',sm.stream_id,',') LIKE CONCAT('%,','".$student_stream."',',%') order by sc.content_id desc";
