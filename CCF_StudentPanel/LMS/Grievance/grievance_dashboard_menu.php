...
<div class="wrapper d-print-none">
    ...
    <nav id="sidebar">        
        ...
        <ul class="list-unstyled components">
            ...
            <li>
            <form id="frmdashboard" name="frmdashboard" action="<?php echo BASE_URL_STUDENT;?>/LMS/dashboard_lms.php" method="post">
            	<input type="hidden" id="txtrollno" name="txtrollno" value="<?php echo $_SESSION["studcollegeRollNo"];?>" />
            </form>
			 <a href="../dashboard_lms.php" ><i class="fa fa-tachometer mr-2"></i>LMS - Dashboard</a>
			
            </li>
            
            <li>
				<a href="feedback_teacher_evaluation.php"><i class="fa-solid fa-file-pen mr-2"></i>Feedback on Teacher Evaluation</a>
            </li>
            
            <li>
				<a href="feedback_institution.php"><i class="fa-solid fa-file-pen mr-2"></i>Feedback on College / Institution</a>
            </li>
            
            <li>
				<a href="feedback_library.php"><i class="fa-solid fa-file-pen mr-2"></i>Feedback on Library</a>
            </li>
            
            <li>
				<a href="feedback_subjects.php"><i class="fa-solid fa-file-pen mr-2"></i>Feedback on New Subjects</a>
            </li>
