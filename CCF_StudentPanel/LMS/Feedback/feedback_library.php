...
$questions = getFeedbackQuestions('LMS_feedback_library_questions');
//print_r($questions);
?>
<!doctype html>
<html lang="en">
    ...
    <div id="content">
        ...
        <div class="pl-3 pr-3 pt-0">
            ...
            <div class="container mt-3 p-0">
            	<div class="row mb-2">
                    <div class="col-md-12">
                        <form action="" method="post" id="library-feedback-form">
                                    ...
                                    foreach ($questions as $key => $question) { ?>
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <input type="hidden" name="library_question_id[]" value="<?php echo $question['id'];  ?>" qid="<?php echo $question['id'];  ?>" qtext="<?php echo $question['que'];  ?>">
                                                <select id="que<?php echo $question['id'];  ?>" name="que<?php echo $question['id'];  ?>" class="custom-select" >
                                                    <option value="" selected>Select</option>
                                                    <option value="5">Totally Agree</option>
                                                    <option value="4">Sometimes Agree</option>
                                                    <option value="3">Cannot Say</option>
                                                    <option value="2">Disagree</option>
                                                    <option value="1">Totally Disagree</option>
                                                </select>
                                            </td>
                                        </tr>
                                    <?php $i++; } } ?>
                            ...
                            <input type="hidden" name="student_roll_number" value="<?php echo $_SESSION["studcollegeRollNo"] ?>">
                                <a class="btn btn-info" href="javascript:void(0)" id="library-feedback-submit">
